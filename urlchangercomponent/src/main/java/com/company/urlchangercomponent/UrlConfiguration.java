package com.company.urlchangercomponent;
...
@PropertySource(name = "com.company.urlchangercomponent", value = "classpath:/com/company/urlchangercomponent/module.properties")
public class UrlConfiguration {

    @Bean("url_UrlViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.company.urlchangercomponent"));
    ...
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.company.urlchangercomponent"));
        return actions;
    }
}
